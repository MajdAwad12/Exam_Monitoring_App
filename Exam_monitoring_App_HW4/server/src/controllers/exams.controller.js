...
import { broadcastToExam } from "../websocket/websocketHub.js";
import { WEBSOCKET_EVENTS } from "../websocket/websocketEventNames.js";
...
export async function updateAttendance(req, res) {
  try {
    ...
    // WebSocket: notify clients that dashboard data changed
      broadcastToExam(savedExam._id, WEBSOCKET_EVENTS.SYSTEM_DATA_CHANGED, { ts: Date.now(), reason: "attendance_updated" });
