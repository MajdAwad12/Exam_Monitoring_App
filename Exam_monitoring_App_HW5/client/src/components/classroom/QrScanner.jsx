...
export default function QrScanner({
  ...
  return (
    <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/40 p-3">
      <div className="flex items-center justify-between gap-3 mb-2">
        <div className="text-sm font-extrabold text-slate-900 dark:text-slate-100">Camera QR Scanner</div>
        {starting ? <div className="text-xs text-slate-600 dark:text-slate-300 font-bold">Starting…</div> : null}
      </div>
